/*
 * @Author: zhaozc
 * @Date: 2021-12-01 19:26:37
 * @LastEditTime: 2021-12-01 19:49:03
 * @LastEditors: Please set LastEditors
 * @Description: 拉取仓库代码
 * @FilePath: /dt-cli/lib/create.js
 */
...
const createAction = async (name, option) => {
  ...
  await clone(`${remote.host}:${remote.userName}/${remote.repo}#${remote.branch}`, name, {}, (err) => { console.log('err', err) });
  // 4. 清理文件
